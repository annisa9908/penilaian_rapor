...
if ($result->num_rows > 0) {
    $input_message = "Error : Nilai untuk mata pelajaran ini sudah ada untuk siswa ini, silahkan masukan nilai yang lain.";
} else {
    ...
    if ($stmt->execute()) {
        $input_message = "Nilai berhasil disimpan!";
    } else {
